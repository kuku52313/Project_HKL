(function () {/*VERSION:201217*/
    function checkWebviewCustomUA(a) {
        for (var b = ["daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; e > d; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    ...
    window.daum = window.daum || {}, function (a) {
        ...
        a.postcode.version = "201217", a.postcode.load = function (a) {
    ...
    postcodeUtils.param = function (a) {
        ...
        var a = Array.prototype.slice.call(arguments), b = a.shift(), c = a.slice(0);
        if (c.length >= 1) for (var d = 0, e = c.length; e > d; d++) {
            var f = c[d];
        ...
        isTouch: "ontouchstart" in window ? !0 : !1, on: function (a, b, c) {
            ...
            var c = b ? b.start : null, d = b ? b.move : null, e = b ? b.end : null, f = !1, g = !1, h = this, i = -1, j = -1, k = 10;
            a && (this.on(a, "touchstart", function (a) {
                ...
                h.stopPropagation(a);
                var b = a.changedTouches && a.changedTouches[0] || a.touches && a.touches[0] || null, c = b && b.pageX, e = b && b.pageY, f = Math.abs(i - c), l = Math.abs(j - e);
        ...
        for (var b = ["lg-f5", "lg-f4", "lg-f3", "d6503"], c = !1, d = 0, e = b.length; e > d; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    }, postcodeUtils.isAndroidWebview = function (a) {
        for (var b = ["version/", "samsungbrowser", "daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; e > d; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    }, postcodeUtils.isAndroidNaverWebview = function (a) {
        for (var b = ["naver"], c = !1, d = 0, e = b.length; e > d; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    ...
    !function (a, b, c, d, e) {
        ...
        a.CONT = {
            MIN_WIDTH: 300, MIN_HEIGHT: 400, DEFAULT_WIDTH: 500, DEFAULT_HEIGHT: 500, ID_PREFIX: "__daum__", EMPTY_FUNCTION: function () {
            }, PROTOCOL: e.protocol, FRAME_POPUP: "popup", FRAME_LAYER: "layer", POPUP_CLOSE_STATE: {COMPLETE: "COMPLETE_CLOSE", FORCE: "FORCE_CLOSE"}
        }, a.MODEL = {VIEWER_COUNT: 0, ID_MAP: {}, TARGET_MAP: {}, POPUP_MAP: {}}, a.viewUtils = function () {
            ...
            function e(a, b, c) {
                var d = !1;
                if (a && !isNaN(a)) a = parseInt(a, 10) < c ? c : parseInt(a, 10); else if (a && "string" == typeof a) if (/^\d+%$/.test(a)) d = !0; else if (/^\d+px$/.test(a)) {
                    d = !1;
            ...
            function j(a, b) {
                if (b) {
                    var c = null;
                    for (var e in q.TARGET_MAP) if (a === q.TARGET_MAP[e]) {
                        c = e;
                        break
                    }
            ...
            var q = a.MODEL;
            return {
                append: j, remove: k, setPopupMap: m, getPopupMap: o, setFrameStyle: function (a, b) {
                    i(a), h(b)
                }, adjustLowIE: b, getNormalizeSize: e, getValidationUrl: l, IE11CompatibleBugFix: p
            }
        }(), a.common = function () {
            function b(a) {
                var b = {}, c = "done" === a.action ? !0 : !1;
            ...
            function g(a, d, e) {
                !c.postMessage || "function" != typeof c.postMessage && "object" != typeof c.postMessage ? (a.name = "", clearInterval(e.timer), e.timer = setInterval(function () {
                    ...
                    var g = c.data, i = f.decodeData(g), j = i.action, k = b(i);
    ...
    !function (a, b, c, d, e) {
        ...
        a.frame = function () {
            function a(a) {
                var b = {border: "0 none", margin: "0", width: "100%", height: "100%", "min-width": "300px", overflow: "hidden", padding: "0"}, c = {
            ...
            function n(b, c) {
                ...
                j.setReady(d, function (a, d) {
                    "done" === a ? c.onComplete !== g.EMPTY_FUNCTION && setTimeout(function () {
                        if (c.onComplete(d), c.autoClose) if (c.onClose !== g.EMPTY_FUNCTION) {
            ...
            function o(a) {
                var b = a.window, c = b.document, d = c.body || c.documentElement || null;
                if (d) for (var e = c.getElementsByTagName("iframe"), f = 0, g = e.length; g > f; f++) {
                    var h = e[f].id || null;
    ...
    var v2 = v2 || {};
    !function (a, b, c, d, e) {
        var f = b, g = "msie" === f.userAgent.browser.name && parseInt(f.userAgent.browser.version.major, 10) <= 6;
        a.themePreprocessor = function () {
            function a(a) {
                for (var b = !1, c = u, d = 0, e = c.length; e > d; d++) {
                    var g = c[d], h = g.key, i = g.match, j = a[h];
                    if (j && f.isHex(j)) for (var k = 0, l = i.length; l > k; k++) {
            ...
            function b(a) {
                for (var b = v, d = !1, e = 0, g = b.length; g > e; e++) for (var h = b[e], i = h.keys, j = h.match, k = h.modifier, l = 0, m = j.length; m > l; l++) {
                    var n = j[l], o = n[0].split("."), p = o[0], q = o[1], r = n[1], s = c(i, a);
                    if (s && f.isHex(s)) {
                        var u = k(s, r);
                        t[p] || (t[p] = {}), t[p][q] = u
                    }
            ...
            function d(a, b) {
                var c = n(a), d = n(b), e = .2, f = o(c.r, c.g, c.b), g = o(d.r, d.g, d.b);
            ...
            function e(a, b) {
                var c = n(a), d = o(c.r, c.g, c.b), e = b >= .5 ? .5 : Math.abs(b), f = d.l - e < 0 ? d.l + e : d.l - e;
            ...
            function i(a, b) {
                var c = .48, d = e(a, c), f = n(b), g = o(f.r, f.g, f.b), h = p(g.h, g.s, d.l);
                return m(h.r, h.g, h.b)
            }
            ...
            function p(a, b, c) {
                var d, e, f;
                if (0 === b) d = e = f = c; else {
                    var g = .5 > c ? c * (1 + b) : c + b - c * b, h = 2 * c - g;
            ...
            var s = {
            ...
            }, t = {}, u = [{key: s.BG, match: ["BODY.bg"]}, {key: s.SEARCH_BG, match: ["SEARCH.bg"]}, {
                key: s.CONTENT_BG,
            ...
            }, {key: s.QUERY_TEXT, match: ["SEARCH.query"]}, {key: s.POSTCODE_TEXT, match: ["RESULT_ADDRESS.postcode"]}, {
                key: s.EMPH_TEXT,
            ...
            }], v = [{keys: [s.SEARCH_BG], match: [["SEARCH.placeHolder", "#bbb"]], modifier: d}, {keys: [s.SEARCH_BG], match: [["SEARCH.bottomLine", "#363636"]], modifier: i}, {
                keys: [s.CONTENT_BG],
                ...
                modifier: d
            }, {keys: [s.CONTENT_BG], match: [["SUGGEST.itemOver", "#f4f4f4"], ["FILTER_ADDRESS.focusBg", "#efefef"]], modifier: h}, {
                keys: [s.PAGE_BG],
                match: [["PAGING.totalPageNumText", "#959595"]],
                modifier: d
            }, {keys: [s.BG], match: [["LOGO.text", "#888"], ["LOGO.logoTextDividingLine", "#dcdcdc"]], modifier: d}, {
                keys: [s.TEXT],
    ...
    !function (a, b, c, d, e) {
        function f(a, b) {
            ...
            if (b) {
                var d = b.q, e = !0;
                d && "string" == typeof d && "" !== m.trim(d) && (c = e === !0 ? m.extend(a, {
                    region_name: encodeURIComponent(d),
                    cq: encodeURIComponent(d),
                    intsh: "on"
                }) : m.extend(a, {userQuery: encodeURIComponent(d), cq: encodeURIComponent(d)}))
            }
            return c
        }
        ...
        function j(a) {
            ...
            var d = p.getNormalizeSize(c.width, n.DEFAULT_WIDTH, n.MIN_WIDTH), e = p.getNormalizeSize(c.height, n.DEFAULT_HEIGHT, n.MIN_HEIGHT);
        ...
        var l = function (a) {
            ...
            u = encodeURIComponent(e.pathname), v = encodeURIComponent(e.search), w = s + "?origin=" + t;
        q.init(w, u, v), j.prototype = {
            open: function (a) {
                l();
