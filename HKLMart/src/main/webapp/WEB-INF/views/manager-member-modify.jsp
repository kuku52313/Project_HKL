        ...
        <div class="col-6" style="z-index: 500">
            ...
            <form class="insertform" name="modifyForm" action="/manager/manager-member-modify" method="POST">
                ...
                <div>
                    ...
                    <div class="record">
                        <label>회원 가입 날짜 </label>&nbsp;&nbsp;
                        <input type="text" class="formCode" id="regdateMember" name="memberRegdate" readonly value="${modify.memberRegdate}"/>
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">

                    <div class="record">
                        <label>회원 주소 </label>&nbsp;&nbsp;
                        <input type="text" class="formCode" id="addressMember" name="memberAddress" readonly value="${modify.memberAddress}"/>
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
