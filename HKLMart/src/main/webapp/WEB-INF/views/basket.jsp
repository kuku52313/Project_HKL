...
<div data-v-7b122ae2="" fragment="5c8f7b94a1" id="container">
    ...
    <div data-v-2c642cc6="" fragment="9ce731cb19" class="frame">
        ...
        <div data-v-2c642cc6="" class="normal-seller-wrapper">
            <div data-v-2c642cc6="" class="wrap-normal-shipping-title"><strong data-v-2c642cc6=""
        ...
        <div data-v-2c642cc6="" class="price_total">총 주문금액 <span
                data-v-2c642cc6=""><%--<c:out value="${list.productPriceAll}">--%></span></div>
        ...
        <div data-v-06f5e281="" data-v-2c642cc6="">
            ...
            <div data-v-06f5e281="" class="order_delivery">
                <dl data-v-06f5e281="">
                    ...
                    <dd data-v-06f5e281=""><input data-v-06f5e281="" type="text" name="" id="orderer_name"
                                                  placeholder="이름" maxlength="15" class="w100per"></dd>
                </dl>
                <dl data-v-06f5e281="">
                    <dt data-v-06f5e281="">휴대폰</dt>
                    <dd data-v-06f5e281=""><input data-v-06f5e281="" type="tel" name="" id="shipping_telephone1"
                                                  maxlength="3" class="w80px"> -
                        <input data-v-06f5e281="" type="tel" name="" id="shipping_telephone2" maxlength="4"
                               class="w80px"> -
                        <input data-v-06f5e281="" type="tel" name="" id="shipping_telephone3" maxlength="4"
                               class="w80px"></dd>
                    <!---->
                    </dd>
                </dl>
        ...
        <div data-v-06f5e281="" class="order_delivery">
            <dl data-v-06f5e281="">
                ...
                <dd data-v-06f5e281=""><input data-v-06f5e281="" type="text" name="" id="shipping_name" placeholder="이름"
                                              class="w100per"></dd>
            </dl>
            <dl data-v-06f5e281="">
                <dt data-v-06f5e281="">휴대폰</dt>
                <dd data-v-06f5e281=""><input data-v-06f5e281="" type="tel" name="" id="shipping_telephone1"
                    ...
                    <input data-v-06f5e281="" type="tel" name="" id="shipping_telephone3" maxlength="4" class="w80px">
                </dd>
            </dl>
            <dl data-v-06f5e281="">
                <dt data-v-06f5e281="">배송주소</dt>
                <dd data-v-06f5e281=""><input data-v-06f5e281="" type="text" name="" readonly="readonly" class="w49per">
                    <input data-v-06f5e281="" type="button" value="우편번호 찾기"
                           class="btn_in_orderforn"><br data-v-06f5e281="">
                    <div data-v-06f5e281="" id="daumPostCodeArea"
                         style="display: none; border: 1px solid; width: 100% !important; height: auto; margin: 5px 0px; position: relative;">
                        <img
                                data-v-06f5e281="" src="//t1.daumcdn.net/localimg/localimages/07/postcode/320/close.png"
                                id="btnFoldWrap" alt="접기 버튼"
                                style="cursor: pointer; position: absolute; right: 0px; top: -1px; z-index: 1;"></div>
                    <input data-v-06f5e281="" type="text" name="" id="address1" readonly="readonly"
                           class="w49per order_addr"> <input data-v-06f5e281="" type="text" name="" id="address2"
                                                             class="w49per order_addr">
                    <div data-v-06f5e281="" class="delivery_add_info_text">* 제주도, 도서 산간 지역 등은 배송이 하루 이상 추가 소요될 수 있습니다
                    </div>
                </dd>
            </dl>
            <dl data-v-06f5e281="">
                ...
                <dd data-v-06f5e281="">
                    ...
                    <input data-v-06f5e281="" type="text" id="delivery-memo" name="" placeholder="50자 이내로 작성해주세요"
                           maxlength="50" class="w98per delivery-memo" style="display: none;">
                </dd>
            </dl>
            <dl style="width: 100%">
    ...
    <div data-v-2c642cc6="" fragment="9ce731cb19" class="frame">
        <form class="last-check">
            ...
            <dl data-v-2c642cc6="" class="order_totalpay">
                ...
                <dd data-v-2c642cc6=""> 얼마<%--<c:out value="${list.productPriceAll}">--%></dd>
                <dt data-v-2c642cc6="">총 배송비</dt>
                <dd data-v-2c642cc6="">0 원</dd>
                <%--배송비를 2500원으로 고정시켜 놓을지 전상품 무료배송 때릴지..?--%>
                <!---->
                <!---->
                <!---->
                <!---->
                <dt data-v-2c642cc6="" class="large">결제 예상 금액</dt>
                <dd data-v-2c642cc6="" class="red large"><%--<c:out value="${list.productPriceAll}">--%></dd>
                <%--배송비 있으면 +2500원 --%>
            </dl>
            <!---->
