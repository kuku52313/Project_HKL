	...
	<div class="wrap">
		<div class="form-wrap">
			...
			<div class="logo" style="text-align: center;">
				<a href=""> <img
					src="resources/img/login/twitter_header_photo_1.png">
				</a>
			</div>

			<form id="login" action="/test" class="input-group" method="post">
				<input type="text" class="input-field_log" name="memberId"
					placeholder="User ID" required> <input type="password"
					class="input-field_log" name="memberPw"
			...
			<form id="register" action="" name="member" class="input-group">
				<input type="text" class="input-check" id="userId" name="memberId"
					placeholder="User ID ex) hkl123" onchange="idCheck()" required> <input
					type="button" id="idCheckBtn" class="idCheckBtn"
					 value="ID Check"> <input
					...
					id="pwCheckBtn" class="pwCheckBtn"> <input type="password"
					class="input-field" onkeyup="checkPwfn()" id="userPwCk"
					name="memberPwCheck" placeholder="PW 확인" required> &nbsp;
				&nbsp; <input type="button" id="pwckCheckBtn" class="pwckCheckBtn">

				<input type="text" class="input-field" id="userEmail"
				...
				<input type="text" class="input-field" id="userName"
					name="memberName" onkeyup="checkNamefn()"
					placeholder="name ex) 홍길동" required> &nbsp; &nbsp; <input
					type="button" id="nameCheckBtn" class="nameCheckBtn"> <input
					type="text" class="input-field" id="userTel" name="memberTel"
					onkeyup="telCheckfn()" placeholder="Tel ex) 010-1234-5678" required>
				&nbsp; &nbsp; <input type="button" id="telCheckBtn"
					class="telCheckBtn"> <input type="button"
					onclick="memberCheckfn()" class="submit" value="REGISTER">
