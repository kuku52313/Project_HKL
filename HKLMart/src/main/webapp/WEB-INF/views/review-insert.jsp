...
<form class="insertform" name="insertForm" action="/board/review-insert?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> <input type="hidden" id="boardReviewId" name="boardReviewMemberId" value="${user.username}" />
    <!-- form header -->
    ...
    <div class="row">
        &nbsp;&nbsp;
        <label>제품 코드</label>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" class="formText" id="codeProduct" name="boardReviewProductCode" minlength="6" maxlength="6" placeholder="제품코드 테스트끝나면 리드온리로 바꾸기" value="${param.productCode}" readonly>
    </div>
    <hr style="border: solid 1px #ffb6b6;">
    <div class="row">
        &nbsp;&nbsp;
        <label>제품명</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" class="formText" id="nameProduct" name="boardReviewProductName" minlength="6" maxlength="6" placeholder="제품이름 테스트끝나면 리드온리로 바꾸기" value="${param.productName}">
    </div>
    <hr style="border: solid 1px #ffb6b6;">
    <div class="row">
        &nbsp;&nbsp;
        <label>별점</label>&nbsp;&nbsp;&nbsp;&nbsp; <select class="formText" id="reviewScore" name="boardReviewScore">
