...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <br> <c:forEach items="${BoardReviewList}" var="list" varStatus="status">
            <table class="ask_table">
                <tr>
                    <th class="product_info">상품 정보</th>
                    <th class="product">
                        <a class="deletebtn" href="manager-review-delete?boardReviewNumber=${list.boardReviewNumber}&amount=10&pageNum=${pageMaker.cri.pageNum}">삭제</a>
                    </th> <!-- 여긴 빈칸-->
                </tr>
                <tr>
                    <!--  <td><a href="/" id="product" style="color: black"><img src="${list.boardReviewImgpath}${list.boardReviewThumbnail}.png"></a></td> -->
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/product-detail?pageNum=1&amount=5&productCode=${list.boardReviewProductCode}" id="product" style="color: black">
