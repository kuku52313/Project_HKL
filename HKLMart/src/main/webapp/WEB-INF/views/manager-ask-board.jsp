        ...
        <div class="col-6">
            ...
            <table class="table table-bordered table-striped" style="background-color: #ffffff;">
                ...
                <c:forEach items="${AskBoardList}" var="list" varStatus="status">
                    <tr>
                        <th>
                            <a href="/manager/manager-ask-answer?boardAskNumber=<c:out value="${list.boardAskNumber}"/>&pageNum=<c:out value="${pageMaker.cri.pageNum}"/>&amount=<c:out value="${pageMaker.cri.amount}"/>" style="color: black">
            ...
            <ul class="pagination justify-content-center" style="margin:20px 0">
                <c:if test="${pageMaker.prev}">
                    <li class="page-item">
                        <a class="page-link" style="color: black;" href="/manager/manager-ask-board?pageNum=${pageMaker.startPage - 1}&amount=10">≪</a>
                    </li>
