        ...
        <div class="col-6">
                ...
                <c:forEach items="${orderProductList}" var="list" varStatus="status">
                    <div class="order_item">
                        ...
                        <dl data-v-6dcc2f72="">
                            ...
                            <dd data-v-6dcc2f72="" style="text-align: center;"> ${list.orderDate} </dd>
                            <dd data-v-6dcc2f72=""><fmt:formatNumber value="${list.productPrice}" pattern="#,###" /> 원
                            </dd>
                            <dd data-v-6dcc2f72=""> ${list.orderState} </dd>
                            <dd data-v-6dcc2f72="" style="text-align: center">
                                <a href="/board/review-insert?productCode=${list.productCode}&productName=${list.productName}">
            ...
            <ul class="pagination justify-content-center" style="margin:20px 0">
                <c:if test="${pageMaker.prev}">
                    <li class="page-item">
                        <a class="page-link" style="color: black;" href="/member/user-order-list?pageNum=${pageMaker.startPage - 1}&amount=10">≪</a>
                    </li>
                ...
                <li class="page-item ${pageMaker.productCri.pageNum == num ? "active":""}">
                    <a class="page-link" style="color: black;" href="/member/user-order-list?pageNum=${num}&amount=10">${num}</a>
                </li>
            </c:forEach> <c:if test="${pageMaker.next}">
                <li class="page-item ">
                    <a class="page-link" style="color: black;" href="/member/user-order-list?pageNum=${pageMaker.endPage + 1}&amount=10">≫</a>
                </li>
            </c:if>
            </ul>
