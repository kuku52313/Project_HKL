    ...
    <div class="row">
        ...
        <div class="col-6" style="z-index: 500">
            ...
            <form class="insertform" name="modifyForm" action="" method="POST">
                ...
                <div>
                    <div class="record">
                        <label>주문 번호</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderNumber" name="orderNumber" readonly value="${orderList.orderNumber}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>회원 ID</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderMemberId" name="orderMemberId" readonly value="${orderList.orderMemberId}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>이름</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderName" name="orderName" readonly value="${orderList.orderName}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>전화번호</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderTel" name="orderTel" readonly value="${orderList.orderTel}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>배송지 주소</label>&nbsp;&nbsp;
                        <input type="text" class="formCode" id="addressMember" name="memberAddress" readonly value="(${orderList.orderAddressPostcode})&nbsp;&nbsp;${orderList.orderAddress}&nbsp;&nbsp;${orderList.orderAddressMember}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>배송 메모</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderMemoId" name="orderMemo" readonly value="${orderList.orderMemo}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <c:set var="i" value="1" /> <c:set var="j" value="5" />
                    <div class="record flex-container">
                        <label>구매 목록</label>&nbsp;&nbsp; <br>
                        <div class="row basket-card">
                            <c:forEach var="list" items="${productList}">
                                ...
                                <c:if test="${i%j == 0 }"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </c:if> <c:set var="i" value="${i+1 }" /> </c:forEach>
                        </div>
                    </div>
                    <div class="record">
                        <label>결제 금액</label>&nbsp;&nbsp; <input type="text" class="formCode" id="orderPaymentId" name="orderPayment" readonly value="${orderList.orderPayment}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                    <div class="record">
                        <label>주문 상태</label>&nbsp;&nbsp; <input type="text" class="formCode" name="orderState" readonly value="${orderList.orderState}" />
                    </div>
                    <hr style="border: solid 1px #ffb6b6;">
                </div>
